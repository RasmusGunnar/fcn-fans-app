...
CREATE INDEX idx_bus_trips_start_at ON public.bus_trips(start_at);
CREATE INDEX idx_bus_trips_fixture_id ON public.bus_trips(fixture_id);
CREATE INDEX idx_bus_trips_organizer ON public.bus_trips(organizer_group_id);

CREATE INDEX idx_events_start_at ON public.events(start_at);
CREATE INDEX idx_events_organizer ON public.events(organizer_group_id);
