...
export default function CreateCommunityScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput style={styles.input} value={type} onChangeText={(t) => setType(t === "area" ? "area" : "city")} />

      <Text style={styles.label}>Beskrivelse</Text>
      <TextInput style={[styles.input, { height: 90 }]} multiline value={description} onChangeText={setDescription} />
