      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <View style={styles.msg}>
            ...
            <Text style={styles.msgMeta}>{item.uid.slice(0, 6)} · {new Date(item.createdAt).toLocaleTimeString()}</Text>
          </View>
        )}
      />
...
const styles = StyleSheet.create({
  ...
  muted: { opacity: 0.7 },
  badge: { marginTop: 10, alignSelf: "flex-start", paddingVertical: 6, paddingHorizontal: 10, borderWidth: 1, borderRadius: 999, fontSize: 12 },
