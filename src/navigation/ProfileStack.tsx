...
import AdminMediaArticlesScreen from '../screens/AdminMediaArticlesScreen';
...
logPerformanceEvent('LazyStack', 'module-evaluated', { stackName: 'ProfileStack' });
...
export function ProfileStack() {
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen name="AdminMediaArticles" component={AdminMediaArticlesScreen} />
